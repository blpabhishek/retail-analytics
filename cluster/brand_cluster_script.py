...
Cust_behavior = pd.read_csv("customer_brand_spend_behaviour.csv", sep=',', index_col=0)
...
features_to_use = ['National Count %', 'Private Count %', 'Average Price', 'Total Sales', 'income_num', 'hh_size_num',
                   'age_num']
...
Aggregations = {'National Count %': 'mean',
                'Private Count %': 'mean',
                'Average Price': 'mean',
                'Total Sales': 'mean',
                'household_key': 'count',
